...
from sklearn.preprocessing import LabelEncoder  # Si tu veux encoder les labels
...
train_neg = pd.read_csv("feed/arabic-sentiment-twitter-corpus/train_Arabic_tweets_negative_20190413.tsv", sep="\t", header=None,  quoting=csv.QUOTE_NONE)
train_neg.rename(columns={0:'label', 1:'tweet'}, inplace=True)
train_neg['label'] = 0

train_pos = pd.read_csv("feed/arabic-sentiment-twitter-corpus/train_Arabic_tweets_positive_20190413.tsv", sep="\t", header=None,  quoting=csv.QUOTE_NONE)
...
# Load test subset
test_pos = pd.read_csv("feed/arabic-sentiment-twitter-corpus/test_Arabic_tweets_positive_20190413.tsv", sep="\t", header=None,  quoting=csv.QUOTE_NONE)
test_pos.rename(columns={0:'label', 1:'tweet'}, inplace=True)
test_pos['label']=1

test_neg = pd.read_csv("feed/arabic-sentiment-twitter-corpus/test_Arabic_tweets_negative_20190413.tsv", sep="\t", header=None,  quoting=csv.QUOTE_NONE)
...
# df_ss2030 = pd.read_csv("arabic-sentiment-analysis-dataset-ss2030-dataset/Arabic Sentiment Analysis Dataset - SS2030.csv")
# # Rename columns to match convention
# df_ss2030 = df_ss2030.rename(columns = {"text":"tweet", "Sentiment": "label"})


# df_reviews = pd.read_csv("arabic-100k-reviews/ar_reviews_100k.tsv", delimiter="\t")
...
# df_arsas = pd.read_csv('arsas-dataset/ArSAS..txt', header = 0, delimiter = "\t")
# # Filter to only have pos and neg tweets, i.e: remove mixed tweets
...
import pickle
filename = 'feed/trained_model_mini_with_emojis.sav'
f = open(filename, 'rb')
...
# evaluate_roc(probs, y_val, "BERT-mini", "feed/arabic-sentiment-twitter-corpus", "feed/arabic-sentiment-twitter-corpus validation")
...
# evaluate_roc(probs, y_test,"BERT-mini", "feed/arabic-sentiment-twitter-corpus","feed/arabic-sentiment-twitter-corpus test")
...
# evaluate_dataset(df_ss2030.tweet.values, df_ss2030.label.values,"BERT-mini no emojis", "feed/arabic-sentiment-twitter-corpus", "ss2030" )


# # Evaluate on the 100k Arabic Reviews Dataset
# evaluate_dataset(df_reviews.tweet.values, df_reviews.label.values,"BERT-mini", "feed/arabic-sentiment-twitter-corpus", "100K Reviews")



# evaluate_dataset(df_arsas.tweet.values, df_arsas.label.values,"BERT-mini", "feed/arabic-sentiment-twitter-corpus", "ArSAS")
...
tweet = "ماعجبنيش واش دارو"  # Example tweet (sentence)
